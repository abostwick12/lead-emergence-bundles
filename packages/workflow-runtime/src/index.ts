import type { BundleRegistry, EntitlementSnapshot } from "@lead-emergence/bundle-registry";
import type { AuthenticatedPrincipal, DomainAccessRequest, Approval } from "@lead-emergence/policy";
import { assertDomainAccess, assertMutationBoundary, PolicyDeniedError } from "@lead-emergence/policy";
import type { ProviderConnection, ProviderOperation } from "@lead-emergence/provider-contracts";
import { assertProviderAuthorized } from "@lead-emergence/provider-contracts";
